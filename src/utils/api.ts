...
// سيرفر منفصل تمامًا بس لشاشة CHEMI (الذكاء الاصطناعي) - عشان الضغط عليه
// ما يأثرش على باقي التطبيق (تسجيل الدخول، المواد، الأخبار) اللي شغالة على BASE_URL
export const CHEMI_BASE_URL = (
  process.env.EXPO_PUBLIC_CHEMI_API_URL ||
  Constants.expoConfig?.extra?.CHEMI_API_URL ||
  ""
).replace(/\/$/, "");
